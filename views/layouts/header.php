        ...
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="<?php echo BASE_URL; ?>">
                <?php if (!empty($globalSettings['company_logo'])): ?>
                    <img src="<?php echo BASE_URL . $globalSettings['company_logo']; ?>" alt="<?php echo htmlspecialchars($globalSettings['company_name'] ?? 'Vigtez Reality'); ?>" height="55" class="me-2 brand-logo">
                <?php else: ?>
